      ...
      <div className="w-3/4 min-h-screen flex flex-col md:flex-row justify-center items-center gap-20 py-12 mx-auto">
        ...
        <div className="flex flex-col items-center md:items-start p-5 w-full md:w-1/2 lg:w-2/5">
          ...
          <p className="text-center md:text-left mb-6 flex flex-col gap-4 text-gray-500">
            ...
            <span className="font-bold text-[1.2rem] text-gray-800">Empowering Growth:</span> Dive deep into
            ...
            <span className="font-bold text-[1.2rem] text-gray-800">Tailored Insights:</span> Our platform
            provides personalized assessments and actionable insights, helping
            individuals and organizations achieve their goals.
            <span className="font-bold text-[1.2rem] text-gray-800">Innovative & Reliable:</span> Backed by
