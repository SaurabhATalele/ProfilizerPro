  ...
  return (
    <div className="w-full h-screen flex flex-col items-center gap-5">
      ...
      <label className="inline-flex items-center mb-5 cursor-pointer">
        ...
        />
        <div className="relative w-11 h-6 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-light bg-primary-light"></div>
